...
import { Component, Optional, Input, Output, Provider, forwardRef, EventEmitter, HostListener, ViewEncapsulation } from '@angular/core';
...
var DATETIME_VALUE_ACCESSOR = new Provider(NG_VALUE_ACCESSOR, { useExisting: forwardRef(function () {
        return DateTime;
    }), multi: true });
/**
 * @name DateTime
